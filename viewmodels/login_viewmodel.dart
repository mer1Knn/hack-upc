...
class LoginViewModel extends BaseViewModel {
  ...
  Future login(LoginRequest request, BuildContext context) async {
    ...
    (await loginUseCase
        ...
        instance<AppPreferences>().setDetails(right.details as DetailsModel?);
        instance<AppPreferences>().setToken(right.token);

        Provider.of<UserViewModel>(context,listen: false).setDetails(right.details as DetailsModel?);
